...
describe 'Correctly implements storing Operations' do
  ...
  it 'should correctly store the value in rA' do
    ...
    @testing.change_memory_word(@testing.ip, @assembler.as_word('STA %d' % @address))
  ...
  it 'should correctly store the partial value in rA' do
    @testing.ra.load_value(@register_word)
    @testing.change_memory_word(@testing.ip, @assembler.as_word('STA %d(2:3)' % @address))
  ...
  it 'should correctly store the indexed and partial value in rA' do
    ...
    @testing.change_memory_word(@testing.ip, @assembler.as_word('STA %d,3(2:3)' % (@address - shift)))
  ...
  it 'should correctly store the value in rX' do
    ...
    @testing.change_memory_word(@testing.ip, @assembler.as_word('STX %d' % @address))
  ...
  it 'should correctly store the value in ri6' do
    ...
    @testing.change_memory_word(@testing.ip, @assembler.as_word('ST6 %d' % @address))
  ...
  it 'should correctly store the value in rJ' do
    ...
    @testing.change_memory_word(@testing.ip, @assembler.as_word('STJ %d' % @address))
  ...
  it 'should store the value in rJ ignoring sign' do
    @testing.rj.store_value(@register_word)
    @testing.change_memory_word(@testing.ip, @assembler.as_word('STJ %d(1:2)' % @address))
  ...
  it 'should clear a memory location with STZ' do
    @testing.change_memory_word(@testing.ip, @assembler.as_word('STZ %d' % @address))
    @testing.clock
    @testing.memory[@address].should eq Word.new([0,0,0,0,0])
  end

  it 'should partially clear a memory location with STZ - 1' do
    @testing.change_memory_word(@testing.ip, @assembler.as_word('STZ %d(4:5)' % @address))
    @testing.clock
  ...
  it 'should partially clear a memory location with STZ - 2' do
    @testing.change_memory_word(@testing.ip, @assembler.as_word('STZ %d(0:3)' % @address))
    @testing.clock
